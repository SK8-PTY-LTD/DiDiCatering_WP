...
if (!function_exists('foodbakery_var_breadcrumb_theme_option')) {
	...
	if (function_exists('is_shop')) {
	    if (is_shop()) {
		$foodbakery_var_post_ID = woocommerce_get_page_id('shop');
	    }
	}
...
if (!function_exists('foodbakery_var_breadcrumb_markup')) {
	...
	if ($foodbakery_var_header_banner_image != '' && $foodbakery_var_sub_header_style == 'with_bg') {
	    ...
	    $foodbakery_sub_style .= ' background:' . $foodbakery_var_page_subheader_color . ' !important;';
	}
	if ($foodbakery_var_subheader_padding_top != '') {
	    $foodbakery_sub_style .= ' padding-top: ' . esc_html($foodbakery_var_subheader_padding_top) . 'px !important;';
	}
	if ($foodbakery_var_subheader_padding_bottom != '') {
	    $foodbakery_sub_style .= ' padding-bottom: ' . esc_html($foodbakery_var_subheader_padding_bottom) . 'px !important;';
	}
	if ($foodbakery_var_subheader_margin_top != '') {
	    $foodbakery_sub_style .= ' margin-top: ' . esc_html($foodbakery_var_subheader_margin_top) . 'px !important;';
	}
	if ($foodbakery_var_subheader_margin_bottom != '') {
	    $foodbakery_sub_style .= ' margin-bottom: ' . esc_html($foodbakery_var_subheader_margin_bottom) . 'px !important;';
	}
	...
	if (!is_404() && !is_singular('restaurants') && !$is_foodbakery_dashboard) {
