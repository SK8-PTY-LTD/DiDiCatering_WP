...
if (!function_exists('foodbakery_var_custom_style_theme_options')) {
	...
	*Theme Colors Classes*/
    ...
    .company-holder.fancy .rating-star .rating-box:before, .company-holder.fancy .fancy-button-prev:hover i, .company-holder.fancy .fancy-button-next:hover i, .company-rating .list-option .shortlist-btn i
	{
