...
if ( ! function_exists( 'foodbakery_var_mail_chimp' ) ) {
    ...
    function foodbakery_var_mail_chimp( $atts, $content = "" ) {
        ...
        echo '<div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="banner-news-letter" ' .foodbakery_allow_special_char($background). '>';
        if ( isset( $foodbakery_var_mail_section_title ) && $foodbakery_var_mail_section_title != '' ) {
            echo '<h5>' . esc_html( $foodbakery_var_mail_section_title ) . '</h5>';
        }
        if ( isset( $foodbakery_var_mail_sub_title ) && $foodbakery_var_mail_sub_title != '' ) {
            echo '<p>' . esc_html( $foodbakery_var_mail_sub_title ) . '</p>';
        }
