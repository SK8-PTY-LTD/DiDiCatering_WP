...
<?php
					...
					echo '<ul class="earning-calculation">';
					printf(__('<li>Earnings of this month is <strong>%s</strong></li>', 'foodbakery'), $currency_sign . foodbakery_get_currency($total_earnings_monthly, false, '', '', false));
					printf(__('<li>Your balance: <strong>%s</strong></li>', 'foodbakery'), $currency_sign . foodbakery_get_currency($over_balance, false, '', '', false));
					printf(__('<li>Total value of your sales <strong>%s</strong></li>', 'foodbakery'), $currency_sign . foodbakery_get_currency($over_total_sale, false, '', '', false));
					printf(__('<li>Total Withdrawal <strong>%s</strong> <a href="javascript:void(0);" class="user_dashboard_ajax" data-id="foodbakery_publisher_withdrawals" data-queryvar="dashboard=withdrawals"><span>(View withdrawal history)</span></a></li>', 'foodbakery'), $currency_sign . foodbakery_get_currency($total_withdrawls, false, '', '', false));
					echo '</ul>';
					?>
