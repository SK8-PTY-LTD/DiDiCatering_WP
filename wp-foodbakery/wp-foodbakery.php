...
if ( ! class_exists('wp_foodbakery') ) {
    ...
    class wp_foodbakery {
        ...
        public static function get_terms_and_conditions_field($label = '', $field_name = '', $show_accept = true) {
            global $foodbakery_plugin_options;
            $label = ( $label == '' ? 'Terms and conditions' : $label );
            ...
            if ( $terms_condition_check == 'on' ) {
                ...
                <div class="checkbox-area">
                    <input type="checkbox" id="<?php echo ($field_name); ?>" class="foodbakery-dev-req-field">
                    <label for="<?php echo ($field_name); ?>">
                        <?php
                        if ( $show_accept ) {
                            _e('Accept ', 'foodbakery');
                        }
                        ?>
        ...
        public static function is_demo_user_modification_allowed() {
            ...
            if ( 'publisher-dashboard.php' === foodbakery_get_current_template() ) {
