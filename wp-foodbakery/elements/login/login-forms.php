                            ...
                            <ul>
                                ...
                                if (is_user_logged_in()) {
                                    ...
                                    if ($facebook_enabled == 'on') :
                                        echo apply_filters('social_login_login_facebook', '<li><a onclick="javascript:show_alert_msg(\'' . esc_html__("Please logout first then try to login again", "foodbakery") . '\')" href="javascript:void(0);" title="Facebook" data-original-title="Facebook" class=" facebook"><span class="social-mess-top fb-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-facebook"></i></a></li>');
                                    endif;
                                    if ($twitter_enabled == 'on') :
                                        echo apply_filters('social_login_login_twitter', '<li><a onclick="javascript:show_alert_msg(\'' . esc_html__("Please logout first then try to login again", "foodbakery") . '\')" href="javascript:void(0);" title="Twitter" data-original-title="twitter" class="twitter"><span class="social-mess-top tw-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-twitter3"></i></a></li>');
                                    endif;
                                    if ($google_enabled == 'on') :
                                        echo apply_filters('social_login_login_google', '<li><a onclick="javascript:show_alert_msg(\'' . esc_html__("Please logout first then try to login again", "foodbakery") . '\')" href="javascript:void(0);" rel="nofollow" title="google" data-original-title="google+" class="gplus"><span class="social-mess-top gplus-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-google4"></i></a></li>');
                                    endif;
                                } else {

                                    // remove id from all links
                                    if ($facebook_enabled == 'on') :
                                        echo apply_filters('social_login_login_facebook', '<li><a href="javascript:void(0);" title="Facebook" data-original-title="Facebook" class="social_login_login_facebook facebook"><span class="social-mess-top fb-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-facebook"></i></a></li>');
                                    endif;
                                    if ($twitter_enabled == 'on') :
                                        echo apply_filters('social_login_login_twitter', '<li><a href="javascript:void(0);" title="Twitter" data-original-title="twitter" class="social_login_login_twitter twitter"><span class="social-mess-top tw-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-twitter3"></i></a></li>');
                                    endif;
                                    if ($google_enabled == 'on') :
                                        echo apply_filters('social_login_login_google', '<li><a  href="javascript:void(0);" rel="nofollow" title="google-plus" data-original-title="google+" class="social_login_login_google gplus"><span class="social-mess-top gplus-social-login" style="display:none">' . esc_html__('Please set API key', 'foodbakery') . '</span><i class="icon-google4"></i></a></li>');
                                    endif;
                                }
